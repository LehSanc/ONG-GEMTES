...
if (isset($_POST['CPF']) && isset($_POST['nome'])) {
    ...
    if (verificarCPF($CPF)) {
        $stmt = $mysqli->prepare("INSERT INTO `usuarios`(`nome`, `CPF`, `senha`, `codigo`) VALUES ('$nome','$CPF',' ','$codigo')"); // Preparar a consulta
        if ($stmt === false) {
            die("Erro na preparação: " . $mysqli->error);
        }
...
<body>
    ...
    <section class="hero-site">
        <div class="interface">
            ...
            <div class="card text-center img-adulto">
                <div class="card-body">
                    <div class="p-2">
            ...
            <div class="container">
                ...
                <h3 class="py-2">Cadastrar usuário</h3>
